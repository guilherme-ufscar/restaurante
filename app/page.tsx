...
export default async function Home() {
  ...
  return (
    <>
      {/* Hero Section com Banners Dinâmicos ou Estático */}
      <section className="relative text-white py-20 md:py-32 overflow-hidden min-h-[500px] flex items-center">
        {/* Background Layer */}
        {banners.length > 0 ? (
        ...
        <Container className="relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-6 animate-fadeIn text-white">
